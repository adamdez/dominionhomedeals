    ...
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-stone-200 bg-white/95 backdrop-blur md:hidden">
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] pt-3">
          <a
            href={`tel:${phoneClean}`}
            className="min-w-[44%] rounded-2xl border border-stone-200 bg-stone-50 px-4 py-3 text-center text-sm font-semibold text-ink-600 shadow-sm transition-colors hover:border-forest-300 hover:text-forest-700"
          >
            Call {SITE.phone}
          </a>

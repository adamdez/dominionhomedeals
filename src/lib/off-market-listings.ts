...
const listings: Record<string, OffMarketListing> = {
  '4129-e-princeton-ave': {
    ...
    highlights: [
      ...
      { text: 'Could also work as extra yard or shop space for a nearby business' },
      { text: 'Sold as-is; buyer needs to verify condition, utilities, zoning, permits, and intended use' },
    ],
    buyerOptions: [
      {
        title: 'Contractor yard',
        body: 'A contractor could use the yard for trucks, trailers, equipment, and materials. The exact use and any screening requirements need to be checked with the City.',
      },
      {
        title: 'Small shop and yard',
        body: 'The two-bay shop and open yard may work for a small repair, service, or trade business that needs both indoor and outdoor space.',
      },
      {
        title: 'Parking and storage',
        body: 'The lot may work for equipment parking, material storage, or general business storage. Buyer needs to confirm that its exact plan is allowed.',
      },
      {
        title: 'Extra space for a nearby business',
        body: 'A business already operating in the area may want the property for more yard space, parking, storage, or a future expansion.',
      },
    ],
    facts: [
    ...
    actionTitle: 'Interested in the property?',
    actionIntro:
      'Send your name, what you want to use the property for, how you plan to buy, and your timing. Adam will get back to you.',
    actionSteps: [
      ['1', 'Review the exterior photos and the $143,000 asking price. Interior photos are coming soon.'],
      ['2', 'Decide whether the lot, shop, and yard fit what you need.'],
      ['3', 'Check your use with the City and verify the buildings, access, and utilities.'],
      ['4', 'Text Adam or send the form with your intended use, buying plan, and timing.'],
    ],
    submitLabel: 'Request property details',
    sourceNote:
      'As of July 23, 2026, the asking price is $143,000. Spokane County records show parcel 35031.0213, approximately 15,244 sq ft / 0.35 acre, and LI zoning. Exterior photos were taken July 23, 2026. Interior photos are coming soon. Buyer should verify the county information and intended use.',
    dueDiligenceNote:
